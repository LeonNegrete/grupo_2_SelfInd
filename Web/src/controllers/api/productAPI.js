...
const productsAPIController = {
        ...
        let response = {
            ...
            products: products.map((product)=>{
                return {
                    ...
                    detail:'/products/' + product.shirt_id
                }
            })
        }
        res.json(response);
    ...
    detail: async (req,res)=>{
        ...
        result.shirt_img = path.join(__dirname,'../../../public/images/Remeras/') + product.shirt_img //El dirname hace que arranque desde el path de apis (Tiene que arrancar desde la raiz)
        res.json(result)
    }
}
